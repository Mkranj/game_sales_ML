...
ggplot(games, aes(x = Consoles_no, y = Global_Sales)) +
  geom_point(data = sales_by_cons_no, aes(y = average, size = count)) + 
...
predictors_to_center <- c("Year_release_n", "Consoles_no", "Consoles_no_sq", "dev_avg_income")
