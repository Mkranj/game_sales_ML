...
## By console
```{r}
group_by(games, console_PS2) %>% summarise(avg = mean(Global_Sales), 
            std = sd(Global_Sales),
            no = n())

group_by(games, console_DS) %>% summarise(avg = mean(Global_Sales), 
            std = sd(Global_Sales),
            no = n())

group_by(games, console_PS3) %>% summarise(avg = mean(Global_Sales), 
            std = sd(Global_Sales),
            no = n())

group_by(games, console_Wii) %>% summarise(avg = mean(Global_Sales), 
            std = sd(Global_Sales),
            no = n())
group_by(games, console_X360) %>% summarise(avg = mean(Global_Sales), 
            std = sd(Global_Sales),
            no = n())
group_by(games, console_PSP) %>% summarise(avg = mean(Global_Sales), 
            std = sd(Global_Sales),
            no = n())
group_by(games, console_PS) %>% summarise(avg = mean(Global_Sales), 
            std = sd(Global_Sales),
            no = n())
group_by(games, console_PC) %>% summarise(avg = mean(Global_Sales), 
            std = sd(Global_Sales),
            no = n())
group_by(games, console_other) %>% summarise(avg = mean(Global_Sales), 
            std = sd(Global_Sales),
            no = n())
...
predictors <- c("Year_release_n", "Genre_F", "Rating_F", "Top_performer_dev", "Dev_games_made", "has_subtitle", "subtitle_count")
